 ...
 */
  ...
  * integer vectors, floating-point vectors, or string data.
  */
 class Msg
 {
 public:
    ...
    * @tparam T The expected type of the data (must be `std::vector<int>`, `std::vector<double>`, or `std::string`).
    ...
    * @tparam T The type to check (must be `std::vector<int>`, `std::vector<double>`, or `std::string`).
