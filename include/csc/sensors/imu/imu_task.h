...
protected:
  ...
  * @param name The name assigned to this task for identification and logging. Defaults to "IMUTask".
  */
...
private:
  IMU imu_sensor; ///< Instance of the IMU sensor interface used for data retrieval and processing. The specific implementation (hardware or simulation) is determined at compile time.
};
