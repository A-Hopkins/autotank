...
namespace task
{
  ...
  public:
     ...
     */
    Task(const std::string& task_name = "UnnamedTask") : name(task_name), current_state(TaskState::NOT_STARTED), running(false) { }
  ...
  private:
    ...
    unsigned int periodic_task_interval_ms = 0; ///< Interval for periodic task processing in milliseconds.
